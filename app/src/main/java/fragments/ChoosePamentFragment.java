...
public class ChoosePamentFragment extends MyBaseFragment {
    ...
    public static ChoosePamentFragment newInstance(String param1, String param2) {
    ...
    void payUsingCard(){
        FragTransactFucntion.replaceFragFromFadeHistory(getFragmentManager(),new SelectCardFragment(),R.id.frame_container_main);
    }
